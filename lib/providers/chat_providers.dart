...
final chatNotifierProvider = StateNotifierProvider.family<ChatNotifier, List<MessageModel>, ChatParams>(
  (ref, params) {
...
final chatProvider = FutureProvider.family<ChatModel?, ChatParams>((ref, params) async {
  final repository = ref.watch(chatRepositoryProvider);
